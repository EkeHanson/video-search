    ...
    <div className="min-h-[calc(100vh-64px)] bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4 sm:p-6 lg:p-8 py-8 sm:py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Sign in to your AI Demo Engine account</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-600 text-xs sm:text-sm">
            ...
            <Link to="/signup" className="text-primary font-semibold hover:text-primary/90">
              Sign up
            </Link>
          </p>
        </div>
